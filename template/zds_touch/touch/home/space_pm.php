...
<div class="wps cl dsm_dxpm"> 
	<div class="pt"><a href="forum.php">{lang homepage}</a> <em> &gt; </em> <a href="home.php?mod=space&do=pm">{lang pm}</a></div>
<!--{if $_G['setting']['version'] != 'X3'}-->
	<div class="dsm_fengexian">
		<ul class="ttp bm cl">
			<li class="a">
				<a href="home.php?mod=space&do=pm"{if $readtag[0]} class="a"{/if}>{lang pm}</a>
			</li>
			<li>
				<a href="home.php?mod=spacecp&ac=pm"{if $readtag[1]} class="a"{/if}>{lang send_pm}</a>
