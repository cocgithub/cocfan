...
<a href="forum.php" title="$_G['setting']['navs'][2]['navname']">$_G['setting']['navs'][2]['navname']</a> <em> &gt; </em> <a href="forum.php?mod=forumdisplay&fid={$_G['forum']['fid']}">{$_G['forum']['name']}</a> $actionsubject <em> > </em> $actiontitle
<!--{else}-->
<a href="forum.php" title="$_G['setting']['navs'][2]['navname']">$_G['setting']['navs'][2]['navname']</a> <em> &gt; </em> <a href="forum.php?mod=forumdisplay&fid={$fup['fid']}">$fup['name']</a> <em> &gt; </em> <a href="forum.php?mod=forumdisplay&fid={$_G['fid']}">{$_G['forum']['name']}</a> $actionsubject <em> &gt; </em> $actiontitle
<!--{/if}-->
    </div>
...
<!--{if !$_G['forum']['allowspecialonly']}-->
	<li <!--{if ($_GET[sortid] || !$special) && $_GET['action'] != 'edit' && $_GET['action'] != 'reply'}-->class="a"<!--{/if}-->>
...
<!-- main postbox start -->
<div class="wp">
	<div class="post_from dsm_postfrom">
		<ul class="cl">
		<!--{if $adveditor}-->
...
<script type="text/javascript">
	var imgexts = typeof imgexts == 'undefined' ? 'jpg, jpeg, zip, gif, png' : imgexts;
	var STATUSMSG = {
