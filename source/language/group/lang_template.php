...
$lang = array (
  ...
  'group_close_notice' => '注：{$_G[setting][navs][3][navname]}关闭后只有团长才可以浏览',
  ...
  'group_demise_notice' => '<h2>温馨提示：</h2><p>{$_G[setting][navs][3][navname]}转让成功后，您依然是该群的团长，但不再是{$_G[setting][navs][3][navname]}创始人，所以可自由退出该{$_G[setting][navs][3][navname]}。</p><p>转让后无法直接恢复群，需被接收者主动操作才可以再次转回，请谨慎操作。</p>',
